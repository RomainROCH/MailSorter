...
class TestOrchestratorIntegration:
    ...
    def setup_method(self, mock_rate_limiter, mock_circuit, mock_factory):
    ...
    def test_classify_basic_flow(
        self, mock_calibrator, mock_prompt, mock_limiter, 
        mock_breaker_fn, mock_cache, mock_factory
    ):
...
class TestOrchestratorBatchMode:
    ...
    def test_batch_classify(
        self, mock_processor_fn, mock_calibrator, mock_prompt, 
        mock_limiter, mock_breaker_fn, mock_cache, mock_factory
    ):
