...
class TestHealthEndpoint:
    ...
    def test_orchestrator_ping_works(self):
        ...
        with patch('backend.core.orchestrator.ProviderFactory') as mock_factory, \
             patch('backend.core.orchestrator.get_smart_cache'), \
             patch('backend.core.orchestrator.get_circuit_breaker'), \
             patch('backend.core.orchestrator.get_rate_limiter'), \
             patch('backend.core.orchestrator.get_prompt_engine'), \
             patch('backend.core.orchestrator.get_calibrator'), \
             patch('backend.core.orchestrator.get_batch_processor'), \
             patch('backend.core.orchestrator.get_feedback_loop'):
