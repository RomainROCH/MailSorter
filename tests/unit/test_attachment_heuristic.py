...
class TestAttachmentHeuristicBasics:
    ...
    def test_safe_attachment(self):
        ...
        result = heuristic.analyze_attachment(
            filename="document.pdf", mime_type="application/pdf", size_bytes=50000
        )
...
class TestSuspiciousExtensions:
    ...
    def test_executable_extensions_flagged(self, ext):
        ...
        result = heuristic.analyze_attachment(
            filename=f"file{ext}", mime_type="application/octet-stream", size_bytes=1000
        )
    ...
    def test_macro_enabled_office_flagged(self, ext):
        ...
        result = heuristic.analyze_attachment(
            filename=f"document{ext}", mime_type="application/octet-stream"
        )
    ...
    def test_double_extension_attack(self):
        ...
        result = heuristic.analyze_attachment(
            filename="invoice.pdf.exe", mime_type="application/octet-stream"
        )
...
class TestMIMETypeDetection:
    ...
    def test_suspicious_mime_type(self):
        ...
        result = heuristic.analyze_attachment(
            filename="unknown", mime_type="application/x-msdownload"
        )
    ...
    def test_mime_extension_mismatch(self):
        ...
        result = heuristic.analyze_attachment(
            filename="document.pdf", mime_type="image/jpeg"
        )
...
class TestKnownMalwareHashes:
    ...
    def test_known_malware_hash_critical(self):
        ...
        try:
            result = heuristic.analyze_attachment(
                filename="safe.pdf", mime_type="application/pdf", content_hash=test_hash
            )
...
class TestScoreAdjustmentClamping:
    ...
    def test_score_not_below_minimum(self):
        ...
        result = heuristic.analyze_attachment(
            filename="safe.jpg", mime_type="image/jpeg", size_bytes=100000
        )
...
class TestHelperFunctions:
    ...
    def test_has_mime_mismatch_detection(self):
        ...
        assert (
            heuristic._has_mime_mismatch("file.unknown", "application/unknown") is False
        )
