...
class TestConfidenceCalibrator:
    ...
    def test_record_correction(self):
        ...
        self.calibrator.record_correction(
            predicted_folder="Invoices", actual_folder="Inbox", confidence=0.7
        )
...
class TestCalibrationEntry:
    ...
    def test_correct_prediction(self):
        ...
        entry = CalibrationEntry(
            predicted="Invoices", actual="Invoices", confidence=0.9, timestamp=0
        )
    ...
    def test_incorrect_prediction(self):
        ...
        entry = CalibrationEntry(
            predicted="Invoices", actual="Inbox", confidence=0.6, timestamp=0
        )
    ...
    def test_unknown_actual(self):
        ...
        entry = CalibrationEntry(
            predicted="Invoices", actual=None, confidence=0.8, timestamp=0
        )
