...
class TestSanitizationPerformance:
    ...
    def test_short_text_sanitization_performance(self):
        ...
        assert result.avg_latency_ms < MAX_SANITIZE_LATENCY_MS, \
    ...
    def test_long_text_sanitization_performance(self):
        ...
        assert result.avg_latency_ms < MAX_SANITIZE_LATENCY_MS * 5, \
    ...
    def test_adversarial_text_sanitization_performance(self):
        ...
        assert result.avg_latency_ms < MAX_SANITIZE_LATENCY_MS * 10, \
...
class TestPrivacyGuardPerformance:
    ...
    def test_privacy_sanitization_performance(self, privacy_guard):
        ...
        assert result.avg_latency_ms < MAX_PRIVACY_LATENCY_MS, \
    ...
    def test_privacy_guard_no_pii_performance(self, privacy_guard):
        ...
        assert result.avg_latency_ms < MAX_PRIVACY_LATENCY_MS / 2, \
...
class TestCachePerformance:
    ...
    def test_cache_lookup_performance(self, cache):
        ...
        result = measure_latency(
            lambda: cache.check(subject, body, sender, folders),
            iterations=500
        )
        
        assert result.avg_latency_ms < MAX_CACHE_LOOKUP_MS, \
    ...
    def test_cache_store_performance(self, cache):
        ...
        assert result.avg_latency_ms < MAX_CACHE_LOOKUP_MS * 2, \
...
class TestEndToEndPerformance:
    ...
    def test_single_email_classification_latency(self, mock_orchestrator_deps):
        ...
        result = measure_latency(
            lambda: orchestrator.handle_message(message),
            iterations=50
        )
        
        assert result.avg_latency_ms < MAX_SINGLE_EMAIL_LATENCY_MS, \
    ...
    def test_ping_latency(self, mock_orchestrator_deps):
        ...
        result = measure_latency(
            lambda: orchestrator.handle_message({"type": "ping"}),
            iterations=100
        )
...
class TestThroughput:
    ...
    def test_sanitization_throughput(self):
        ...
        assert throughput > 1000, \
            f"Throughput {throughput:.0f} emails/sec below target"
    
    def test_privacy_guard_throughput(self):
        """Privacy guard should handle reasonable throughput."""
        guard = PrivacyGuard()
        emails = [
            f"Contact user{i}@example.com about project {i}"
            for i in range(100)
        ]
