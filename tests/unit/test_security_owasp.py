...
from backend.utils.sanitize import sanitize_email_payload, sanitize_subject, sanitize_body
from backend.core.privacy import PrivacyGuard
from backend.utils.security import sign_classification, verify_signature, create_signed_result
...
class TestSensitiveDataExposure:
    ...
    def test_phone_numbers_redacted(self):
        ...
        assert "555-123-4567" not in sanitized or "<PHONE" in sanitized or "[PHONE" in sanitized
